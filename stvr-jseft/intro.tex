...
\item A combination of function \emph{coverage maximization} and function \emph{state reduction}  algorithms to efficiently generate unit test cases;
