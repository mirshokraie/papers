...
\item A mutation-based method to effectively create a minimized set of test oracles; %capable of detecting faults in the \javascript code and the DOM tree of the  application;
\item The implementation of our approach in an open-source tool called \tool;%,  which requires no browser modifications, and is hence portable;
