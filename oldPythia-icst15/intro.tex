...
\item A DOM mutation-based method to effectively generate DOM level test oracles; %capable of detecting faults in the \javascript code and the DOM tree of the  application;
