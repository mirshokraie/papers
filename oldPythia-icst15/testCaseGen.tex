...
Going back to our running example in \figref{funcCovgExample}, at the entry point of \code{setDim}, we yield the value and type of both the input parameter \code{dimension} and global variable \code{currentDim}, which is accessed in the function. Similarly, at the exit point, we log the values and types of the returned variable \code{dim} and \code{currentDim}.
