...
\begin{figure}[!t]
  ...
  \vspace{-0.3in} 
  \mycaption{Intra code dependency through backward slicing.}
...
An intra code dependency is defined as $<criterion, codeSts>$, where $criterion$ is a variable at the initial point of contact, and $codeSts$ is the set of data and control flow statements that are either affected by the $ctiterion$ or have some effect on the $criterion$. 
\end{mydef}
