...
\end{mydef}
\textsc{GetBWSlice} in lines  15 and 21 of \algref{algorithm} computes backward slice with respect to assertion related DOM mutations, and candidate DOM property mutations respectively.
