...
In order to link DOM assertions to the relevant application's code we further need to track DOM's evolution as the test case runs (\textsc{GetDomMuts} in line 13 of the algorithm). 
