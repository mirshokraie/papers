...
Let's assume that in line 14 of \figref{example}(a) \code{selItem.price}, which is assigned by the original price of the merchandise is 100, and \code{selItem.quantity} is 1. In line 18, the discount, which is calculated based on the \code{data} value of the \code{couponButt} element is 30. 
